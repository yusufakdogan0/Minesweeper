...
struct qt_meta_stringdata_CLASSMineFieldENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSMineFieldENDCLASS = QtMocHelpers::stringData(
    "MineField"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSMineFieldENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject MineField::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSMineFieldENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSMineFieldENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSMineFieldENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<MineField, std::true_type>
    >,
    nullptr
} };
...
void *MineField::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSMineFieldENDCLASS.stringdata0))
